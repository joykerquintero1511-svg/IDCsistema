...
<body>
    ...
    <div class="idc-impresion-contenedor">
        ...
        while ($fila_encabezado = mysqli_fetch_assoc($resultado)) {
            if ($fila_encabezado['descripcion_nota_1'] !== null && $fila_encabezado['descripcion_nota_1'] !== "") {
                $nombre_actividad_1 = ucwords(strtolower($fila_encabezado['descripcion_nota_1']));
            }
            if ($fila_encabezado['descripcion_nota_2'] !== null && $fila_encabezado['descripcion_nota_2'] !== "") {
                $nombre_actividad_2 = ucwords(strtolower($fila_encabezado['descripcion_nota_2']));
                $mostrar_actividad_2 = true;
            }
            if ($fila_encabezado['nota_2'] !== null && $fila_encabezado['nota_2'] !== "") {
                $mostrar_actividad_2 = true;
            }
        }
